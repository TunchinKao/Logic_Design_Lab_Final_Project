...
set_property IOSTANDARD LVCMOS33 [get_ports {vagRed[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vagRed[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vagRed[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vagRed[0]}]
set_property PACKAGE_PIN N19 [get_ports {vagRed[3]}]
set_property PACKAGE_PIN J19 [get_ports {vagRed[2]}]
set_property PACKAGE_PIN H19 [get_ports {vagRed[1]}]
set_property PACKAGE_PIN G19 [get_ports {vagRed[0]}]
