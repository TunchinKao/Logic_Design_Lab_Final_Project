...
# set_property IOSTANDARD LVCMOS33 [get_ports ctBt]
# set_property IOSTANDARD LVCMOS33 [get_ports dwBt]
# set_property IOSTANDARD LVCMOS33 [get_ports ltBt]
# set_property IOSTANDARD LVCMOS33 [get_ports rtBt]
# set_property IOSTANDARD LVCMOS33 [get_ports upBt]
# set_property PACKAGE_PIN U18 [get_ports ctBt]
# set_property PACKAGE_PIN U17 [get_ports dwBt]
# set_property PACKAGE_PIN W19 [get_ports ltBt]
# set_property PACKAGE_PIN T17 [get_ports rtBt]
# set_property PACKAGE_PIN T18 [get_ports upBt]
...
set_property PACKAGE_PIN J1 [get_ports pmod_1_high]
set_property PACKAGE_PIN L2 [get_ports pmod_2_high]
set_property PACKAGE_PIN G2 [get_ports pmod_4_high]
set_property PACKAGE_PIN A14 [get_ports pmod_1_mid]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_1_high]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_1_low]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_1_mid]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_2_high]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_2_low]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_2_mid]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_4_high]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_4_low]
set_property IOSTANDARD LVCMOS33 [get_ports pmod_4_mid]
set_property PACKAGE_PIN A16 [get_ports pmod_2_mid]
set_property PACKAGE_PIN B16 [get_ports pmod_4_mid]
set_property PACKAGE_PIN P18 [get_ports pmod_4_low]
set_property PACKAGE_PIN M18 [get_ports pmod_2_low]
set_property PACKAGE_PIN K17 [get_ports pmod_1_low]
